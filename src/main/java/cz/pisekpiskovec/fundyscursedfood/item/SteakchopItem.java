...
public class SteakchopItem extends FundysCursedFoodModElements.ModElement {
	@ObjectHolder("fundys_cursed_food:steakchop")
	public static final Item block = null;

	public SteakchopItem(FundysCursedFoodModElements instance) {
		super(instance, 2);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(CreativeTabItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(16).saturation(25.599999999999998f)

							.meat().build()));
			setRegistryName("steakchop");
		}
