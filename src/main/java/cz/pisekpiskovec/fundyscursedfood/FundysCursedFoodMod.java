 ...
 *
 */
package cz.pisekpiskovec.fundyscursedfood;
...
@Mod("fundys_cursed_food")
public class FundysCursedFoodMod {
	public static final Logger LOGGER = LogManager.getLogger(FundysCursedFoodMod.class);
	public static final String MODID = "fundys_cursed_food";
